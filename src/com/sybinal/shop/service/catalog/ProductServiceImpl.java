...
public class ProductServiceImpl implements ProductService {
	...
	public Map<String, Object> getProductRelation(Map<String, Object> conditions) {
		...
		ProductExample.Criteria criteria = productExample.createCriteria();  //Criteria  标准
		Object condition = null;
		criteria.andProductStatusEqualTo(0);
		/* 指定分类ID */
		if ((condition = conditions.get("categoryId")) != null)    //在mybatis逆向工程生成的文件XxxExample.java中包含一个static的内部类Criteria
			criteria.andCategoryIdEqualTo((int) condition);          //Criteria中的方法是定义SQL 语句where后的查询条件。
		/* 指定商品名称 */
