...
import com.sybinal.shop.mapper.*;
...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	@Transactional
	public void savePaymentHistory(Order order,String a,String b,String  c) throws IllegalAccessException, InvocationTargetException {
		...
		paymentHistory.setOut_trade_no(a);
		paymentHistory.setSubject(b);
		//Integer i = (Integer)Integer.parseInt(c);
		paymentHistory.setTotal_amount(orderPrice);
		order.setPrice(orderPrice);
		// 购物车区分
		orderHistoryMapper.insert(orderHistory);
